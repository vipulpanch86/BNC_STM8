...
@inline static void WriteToDisplay(uint8_t dispNo, volatile uint8_t data)
{
  ...
  DISP_EN6_PORT->ODR |= (uint8_t)DISP_EN6_PIN;
  DISP_EN7_PORT->ODR |= (uint8_t)DISP_EN7_PIN;
  DISP_EN8_PORT->ODR |= (uint8_t)DISP_EN8_PIN;
  DISP_EN9_PORT->ODR |= (uint8_t)DISP_EN9_PIN;
