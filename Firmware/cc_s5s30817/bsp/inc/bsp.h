...
#define MUX1_MSC_PORT (GPIOA)
#define MUX1_MSC_PIN  (GPIO_PIN_3)

#define MUX0_MSC_PORT (GPIOA)
#define MUX0_MSC_PIN  (GPIO_PIN_4)
...
#define KEY_RET0_PORT (GPIOE)
#define KEY_RET0_PIN  (GPIO_PIN_0)

#if (MOTHER_BOARD_TYPE == BSP_MB_BIG)

#define MUX0_MSB_PORT (GPIOE)
#define MUX0_MSB_PIN  (GPIO_PIN_1)
...
#define MUX0_MSB_PORT (GPIOG)
#define MUX0_MSB_PIN  (GPIO_PIN_6)
...
#define KEY_RET1_PORT (GPIOF)
#define KEY_RET1_PIN  (GPIO_PIN_0)
...
#define MUX1_MSB_PORT (GPIOF)
#define MUX1_MSB_PIN  (GPIO_PIN_5)

#define MUX1_MSA_PORT (GPIOF)
#define MUX1_MSA_PIN  (GPIO_PIN_6)

#define MUX1_MEN_PORT (GPIOF)
#define MUX1_MEN_PIN  (GPIO_PIN_7)
