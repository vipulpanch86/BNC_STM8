...
static void GPIO_Config(void)
{
  ...
  GPIO_Init(MUX0_MSA_PORT, MUX0_MSA_PIN, GPIO_MODE_OUT_PP_LOW_SLOW);
  GPIO_Init(MUX0_MSB_PORT, MUX0_MSB_PIN, GPIO_MODE_OUT_PP_LOW_SLOW);
  GPIO_Init(MUX0_MSC_PORT, MUX0_MSC_PIN, GPIO_MODE_OUT_PP_LOW_SLOW);

  /* Initialize Multiplexer 1 lines */
  GPIO_Init(MUX1_MSA_PORT, MUX1_MSA_PIN, GPIO_MODE_OUT_PP_LOW_SLOW);
  GPIO_Init(MUX1_MSB_PORT, MUX1_MSB_PIN, GPIO_MODE_OUT_PP_LOW_SLOW);
  GPIO_Init(MUX1_MSC_PORT, MUX1_MSC_PIN, GPIO_MODE_OUT_PP_LOW_SLOW);
  GPIO_Init(MUX1_MEN_PORT, MUX1_MEN_PIN, GPIO_MODE_OUT_PP_HIGH_SLOW);

  /* Initalize Keypad Columns as Input Return Lines */
  GPIO_Init(KEY_RET0_PORT, KEY_RET0_PIN, GPIO_MODE_IN_FL_NO_IT);
  GPIO_Init(KEY_RET1_PORT, KEY_RET1_PIN, GPIO_MODE_IN_FL_NO_IT);
