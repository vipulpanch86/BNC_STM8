...
static void GPIO_Config(void)
{
  ...
  GPIO_Init(DISP_DB7_PORT, (GPIO_Pin_TypeDef)DISP_DB7_PIN, GPIO_MODE_OUT_PP_LOW_SLOW);
  
  /* Initialize Display Output Enable bits */
  GPIO_Init(DISP_OEN_PORT, (GPIO_Pin_TypeDef)DISP_OEN_PIN, GPIO_MODE_OUT_PP_LOW_SLOW);
