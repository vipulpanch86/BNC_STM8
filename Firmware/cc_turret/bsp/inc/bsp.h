...
#define DISP_DB_PORT  (GPIOB)

#define DISP_DB0_PORT (GPIOB)
#define DISP_DB0_PIN  (GPIO_PIN_0)

#define DISP_DB1_PORT (GPIOB)
#define DISP_DB1_PIN  (GPIO_PIN_1)

#define DISP_DB2_PORT (GPIOB)
#define DISP_DB2_PIN  (GPIO_PIN_2)

#define DISP_DB3_PORT (GPIOB)
#define DISP_DB3_PIN  (GPIO_PIN_3)

#define DISP_DB4_PORT (GPIOB)
...
#define DISP_DB7_PORT (GPIOB)
#define DISP_DB7_PIN  (GPIO_PIN_7)

#define DISP_EN0_PORT (GPIOC)
#define DISP_EN0_PIN  (GPIO_PIN_1)

#define DISP_EN1_PORT (GPIOC)
#define DISP_EN1_PIN  (GPIO_PIN_2)

#define DISP_EN2_PORT (GPIOC)
#define DISP_EN2_PIN  (GPIO_PIN_3)

#define DISP_EN3_PORT (GPIOC)
#define DISP_EN3_PIN  (GPIO_PIN_4)

#define DISP_OEN_PORT (GPIOC)
#define DISP_OEN_PIN  (GPIO_PIN_5)
