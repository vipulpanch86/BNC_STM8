...
#define DISP_MS0_PIN  (GPIO_PIN_3)

#define DISP_MS1_PORT (GPIOA)
#define DISP_MS1_PIN  (GPIO_PIN_4)

#define DISP_MS3_PORT (GPIOA)
#define DISP_MS3_PIN  (GPIO_PIN_6)
...
#define KEY_SCA2_PORT (GPIOE)
#define KEY_SCA2_PIN  (GPIO_PIN_4)
...
#define DISP_LE1_PORT (GPIOF)
#define DISP_LE1_PIN  (GPIO_PIN_0)
...
#define MUX0_MSC_PORT (GPIOF)
#define MUX0_MSC_PIN  (GPIO_PIN_5)
