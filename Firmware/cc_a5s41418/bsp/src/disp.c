...
static const uint8_t MS_PIN[DISP_MAX_NB_SEL][4] = 
{
  ...
  DISP_MS0_PIN * 0, DISP_MS1_PIN * 1, DISP_MS2_PIN * 1, DISP_MS3_PIN * 0,
  DISP_MS0_PIN * 1, DISP_MS1_PIN * 1, DISP_MS2_PIN * 1, DISP_MS3_PIN * 0,
  DISP_MS0_PIN * 0, DISP_MS1_PIN * 0, DISP_MS2_PIN * 0, DISP_MS3_PIN * 1,
