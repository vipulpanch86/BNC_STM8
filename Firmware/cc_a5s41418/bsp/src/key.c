...
#define NB_SC_4_RT9    (1)

#define SC_NB_MUXED    (0)

#define MAX_RT_LINES   (10)

#define NB_RT_4_SC0    (10)
...
static const GPIO_TypeDef *SCAN_PORT[MAX_SC_LINES - SC_NB_MUXED] =
{
  KEY_SCA0_PORT,
  KEY_SCA1_PORT,
  KEY_SCA2_PORT
...
/* List of Keypad Scan Lines GPIO Port Pins */
static const uint8_t SCAN_PIN[MAX_SC_LINES - SC_NB_MUXED] =
{
  KEY_SCA0_PIN,
  KEY_SCA1_PIN,
  KEY_SCA2_PIN
...
static const uint8_t NB_SC_4_RT_ACC[MAX_RT_LINES] =
{
  ...
  NB_SC_4_RT0 + NB_SC_4_RT1 + NB_SC_4_RT2 + NB_SC_4_RT3 + NB_SC_4_RT4 + NB_SC_4_RT5 + NB_SC_4_RT6 + NB_SC_4_RT7 + NB_SC_4_RT8,
};
...
#define SetScanLine(nb) \
  do{ \
    ((GPIO_TypeDef *)(SCAN_PORT[nb]))->ODR |= (uint8_t)SCAN_PIN[nb]; \
  } while(0)
