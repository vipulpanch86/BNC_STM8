...
#define MUX0_MSC_PORT (GPIOA)
#define MUX0_MSC_PIN  (GPIO_PIN_3)

#define DISP_EN9_PORT (GPIOA)
#define DISP_EN9_PIN  (GPIO_PIN_4)

#define DISP_EN5_PORT (GPIOA)
#define DISP_EN5_PIN  (GPIO_PIN_6)
...
#define DISP_EN6_PORT (GPIOB)
#define DISP_EN6_PIN  (GPIO_PIN_7)
...
#define DISP_EN7_PORT (GPIOE)
#define DISP_EN7_PIN  (GPIO_PIN_0)

#if (MOTHER_BOARD_TYPE == BSP_MB_BIG)

#define DISP_EN8_PORT (GPIOE)
#define DISP_EN8_PIN  (GPIO_PIN_1)

#define DISP_EN2_PORT (GPIOE)
#define DISP_EN2_PIN  (GPIO_PIN_2)

#else

#define DISP_EN8_PORT (GPIOG)
#define DISP_EN8_PIN  (GPIO_PIN_6)

#define DISP_EN2_PORT (GPIOG)
#define DISP_EN2_PIN  (GPIO_PIN_7)

#endif

#define DISP_EN3_PORT (GPIOE)
#define DISP_EN3_PIN  (GPIO_PIN_3)

#define DISP_EN4_PORT (GPIOE)
#define DISP_EN4_PIN  (GPIO_PIN_4)
...
#define MUX0_MEN_PORT (GPIOF)
#define MUX0_MEN_PIN  (GPIO_PIN_0)
...
#define MUX0_MSB_PORT (GPIOF)
#define MUX0_MSB_PIN  (GPIO_PIN_5)

#define MUX0_MSA_PORT (GPIOF)
#define MUX0_MSA_PIN  (GPIO_PIN_6)

#define DISP_EN1_PORT (GPIOF)
#define DISP_EN1_PIN  (GPIO_PIN_7)
